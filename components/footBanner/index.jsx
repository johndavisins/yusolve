...
export default function FootBanner() {
  return (
    <LampContainer>
      ...
      <motion.p
        className="text-gray-300 pt-3 pb-7 text-base sm:text-lg text-center max-w-xl"
      >
        Join 150+ trucking companies that rely on YUSOLVE for their safety, HR,
        insurance, and fleet compliance. Get your free consultation today — no
        strings attached.
      </motion.p>
      <Consultation />
    </LampContainer>
