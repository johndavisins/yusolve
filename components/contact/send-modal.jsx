...
export default function SendModal({ page = " Modal window" }) {
  ...
  return (
    ...
    >
      <form
        className={`flex flex-col gap-5 w-[90%] sm:w-[400px] bg-white bg-opacity-5 backdrop-blur-md border border-white border-opacity-40 p-5 rounded-xl relative ${
          sendModal
      ...
      >
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2.00018 2L22 22" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M21.9999 2L2.00001 22" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
        ...
        <div className="flex flex-col justify-center items-center gap-5 py-3">
          <div className="w-full xs:w-3/4">
            <Input type={"text"} register={register} name={"name"} placeholder={"Full Name"} id="name" required />
          </div>
          <div className="w-full xs:w-3/4">
            <Input type={"text"} register={register} name={"email"} placeholder={"Email Address"} id="email" required />
          </div>
          <div className="w-full xs:w-3/4">
            <Input type={"text"} register={register} name={"phone"} placeholder={"Phone Number"} id="phone" required />
          </div>
          <button
            type="submit"
            disabled={reqloading}
